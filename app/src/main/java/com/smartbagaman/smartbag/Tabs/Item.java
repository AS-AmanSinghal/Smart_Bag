...
import com.smartbagaman.smartbag.Adapters.ItemTabAdapter;
...
import com.smartbagaman.smartbag.Response.ItemResponse.Datum;
...
public class Item extends Fragment
{
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView=view.findViewById(R.id.tab_item_recycler);
        recyclerView.setLayoutManager(new LinearLayoutManager(this.getContext(),RecyclerView.VERTICAL,false));
        getItem();
        adapter=new ItemTabAdapter(getContext(),itemList);
